...
select pvp from acoes where pl<=5;

select papel, cotacao, pl, pvp from acoes where pl<=5;


select dividend_yield from acoes where pl<=0.12;

select papel, cotacao, pl, pvp,dividend_yield from acoes where pl<=0.12;

select patrimonio_liquido from acoes where patrimonio_liquido>100000000000;

select papel, cotacao, pl, pvp,patrimonio_liquido,dividend_yield from acoes where patrimonio_liquido>100000000000;

select pvp from acoes where pl<=5;

select papel, cotacao from acoes where patrimonio_liquido>100000000000 and dividend_yield>0.12 and pvp <=5 and pl<25;
